app.controller('FacultiesSubcategoriesCtrl',
    function($scope, $log, $location, $q, $route, $filter, indicatorFactory,
        facultiesSubcategoriesTable, facultiesSubcategoriesLine,
        facultiesSubcategoriesColumn) {

	    $log.info("Loading FacultiesSubcategoriesCtrl Controller");
	    ...
	    function initialize() {
		    ...
		    $scope.chartTypes = [ {
		      name : "Table",
		      id : "Table",
		      factory : facultiesSubcategoriesTable
		    }, {
		      name : "Lines",
		      id : "LineChart",
		      factory : facultiesSubcategoriesLine
		    // TODO Set properly
		    }, {
		      name : "Columns",
		      id : "ColumnChart",
		      factory : facultiesSubcategoriesColumn
		    // TODO Set properly
		    } ];
